...
// Paddle (Billing) checkout: paddle.js loads from cdn.paddle.com, the overlay
// checkout runs in an iframe from buy.paddle.com, and paddle.js calls its API
// across *.paddle.com. Sandbox uses the same wildcard hosts.
const PADDLE_HOSTS = 'https://*.paddle.com https://cdn.paddle.com https://buy.paddle.com';
...
const ContentSecurityPolicy = [
  ...
  `script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://cdnjs.cloudflare.com https://accounts.google.com ${CASHFREE_HOSTS} ${PADDLE_HOSTS}`,
  ...
  `connect-src 'self' data: blob: ${SUPABASE_HOST} ${AI_BACKEND} wss://*.supabase.co https://cdnjs.cloudflare.com https://accounts.google.com ${CASHFREE_HOSTS} ${PADDLE_HOSTS}`,
...
const securityHeaders = [
  ...
  // Disable powerful browser features the app doesn't use, by default
  {
    ...
    value:
      'camera=(), microphone=(), geolocation=(), interest-cohort=(), payment=(self "https://sdk.cashfree.com" "https://payments.cashfree.com" "https://payments-test.cashfree.com" "https://buy.paddle.com"), usb=()',
  },
