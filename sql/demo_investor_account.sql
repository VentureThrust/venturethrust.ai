...
declare
  ...
  rec   record;
  ids   uuid[] := '{}';
  founder_emails text[] := array['nithin@nellaraagrichain.com', 'ann@zylohealth.in', 'karthik@voltaneer.in', 'rohan@aegisdronesystems.in', 'sujith@kadalsystems.in', 'nandita@anvaya-ai.in', 'rahul@thoovalstudios.com', 'sreelakshmi@kalpanarobotics.in', 'ramesh@metricon-interconnect.in', 'anjali@puzhafoods.in'];
...
begin
  ...
  for rec in
    select * from (values
      ...
      ('Kalpana Robotics',
       ...
       'sreelakshmi@kalpanarobotics.in',
       null,
      ...
      ('Metricon Interconnect',
       ...
       'ramesh@metricon-interconnect.in',
       null,
  ...
  select gen_random_uuid()::text, sp.created_by, fo.id, sp.id, t.fname, t.ftype,
    ...
    from (values
      ...
      ('nellara-agrichain','02 Financials','Financial Model FY27.xlsx','Sheet',7262,2,1,23),
      ('nellara-agrichain','02 Financials','Unit Economics by SKU.xlsx','Sheet',5736,9,2,28),
      ('nellara-agrichain','02 Financials','Cap Table.xlsx','Sheet',5616,16,3,33),
      ...
      ('nellara-agrichain','04 Customers and Traction','Customer List Jul 2026.xlsx','Sheet',5840,13,3,24),
      ...
      ('zylo-health','02 Financials','Financial Model.xlsx','Sheet',7288,10,1,15),
      ('zylo-health','02 Financials','Per Scan Unit Economics.xlsx','Sheet',5637,17,2,20),
      ('zylo-health','02 Financials','Cap Table.xlsx','Sheet',5607,24,3,25),
      ...
      ('zylo-health','04 Customers and Traction','Scan Volume Report Jul 2026.xlsx','Sheet',5881,7,2,6),
      ...
      ('voltaneer','02 Financials','Financial Model.xlsx','Sheet',7275,11,1,46),
      ('voltaneer','02 Financials','ARR Bridge FY27.xlsx','Sheet',5613,18,2,7),
      ('voltaneer','02 Financials','Cap Table.xlsx','Sheet',5611,25,3,12),
      ...
      ('voltaneer','04 Customers and Traction','Customer Savings Report.xlsx','Sheet',5869,8,2,37),
      ('voltaneer','04 Customers and Traction','Sales Cycle Export Jul 2026.xlsx','Sheet',5970,15,3,42),
      ...
      ('aegis-drone-systems','02 Financials','Financial Model.xlsx','Sheet',7282,12,1,33),
      ('aegis-drone-systems','02 Financials','Project Level P and L.xlsx','Sheet',5638,19,2,38),
      ('aegis-drone-systems','02 Financials','Cap Table.xlsx','Sheet',5617,0,3,43),
      ...
      ('aegis-drone-systems','04 Customers and Traction','Client List.xlsx','Sheet',5834,9,2,24),
      ...
      ('kadal-systems','02 Financials','Financial Model.xlsx','Sheet',7265,6,1,15),
      ('kadal-systems','02 Financials','Unit Cost Breakdown.xlsx','Sheet',5667,13,2,20),
      ('kadal-systems','02 Financials','Cap Table.xlsx','Sheet',5603,20,3,25),
      ...
      ('kadal-systems','04 Customers and Traction','Unit Sales Register Jun 2026.xlsx','Sheet',5779,22,1,45),
      ...
      ('anvaya-ai','02 Financials','Financial Model.xlsx','Sheet',7274,0,1,41),
      ('anvaya-ai','02 Financials','Unit Economics.xlsx','Sheet',5606,7,2,46),
      ('anvaya-ai','02 Financials','Cap Table.xlsx','Sheet',5558,14,3,7),
      ('anvaya-ai','03 Product and Technology','Data Pipeline and Provenance.pdf','PDF',3083,21,1,12),
      ('anvaya-ai','04 Customers and Traction','Customer Contracts.xlsx','Sheet',5663,2,1,17),
