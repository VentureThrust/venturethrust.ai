  ...
  for r in select * from (values
    ...
    select gen_random_uuid()::text, v_own, fo.id, s_id, f.fname, f.ftype,
      ...
      from (values
        ...
        ('aether-semiconductors','02 Financials','Unit Economics.xlsx','Sheet',5559,2),
        ('aether-semiconductors','02 Financials','Cap Table.xlsx','Sheet',5552,3),
        ...
        ('aether-semiconductors','04 Customers and Traction','Customers.xlsx','Sheet',5565,2),
        ...
        ('verdant-climate','02 Financials','Financial Model.xlsx','Sheet',7130,1),
        ('verdant-climate','02 Financials','Unit Economics.xlsx','Sheet',5572,2),
        ('verdant-climate','02 Financials','Cap Table.xlsx','Sheet',5580,3),
        ...
        ('verdant-climate','04 Customers and Traction','Customers.xlsx','Sheet',5574,2),
        ...
        ('orbitfall-systems','02 Financials','Financial Model.xlsx','Sheet',7119,1),
        ('orbitfall-systems','02 Financials','Unit Economics.xlsx','Sheet',5513,2),
        ('orbitfall-systems','02 Financials','Cap Table.xlsx','Sheet',5550,3),
        ...
        ('orbitfall-systems','04 Customers and Traction','Customers.xlsx','Sheet',5561,2),
        ...
        ('praan-robotics','02 Financials','Financial Model.xlsx','Sheet',7134,1),
        ('praan-robotics','02 Financials','Unit Economics.xlsx','Sheet',5546,2),
        ('praan-robotics','02 Financials','Cap Table.xlsx','Sheet',5573,3),
        ...
        ('praan-robotics','04 Customers and Traction','Customers.xlsx','Sheet',5616,2),
        ...
        ('quantiva','02 Financials','Financial Model.xlsx','Sheet',7174,1),
        ('quantiva','02 Financials','Unit Economics.xlsx','Sheet',5509,2),
        ('quantiva','02 Financials','Cap Table.xlsx','Sheet',5550,3),
        ...
        ('quantiva','04 Customers and Traction','Customers.xlsx','Sheet',5543,2),
        ...
        ('sarva-health-ai','02 Financials','Financial Model.xlsx','Sheet',7127,1),
        ('sarva-health-ai','02 Financials','Unit Economics.xlsx','Sheet',5536,2),
        ('sarva-health-ai','02 Financials','Cap Table.xlsx','Sheet',5564,3),
        ...
        ('sarva-health-ai','04 Customers and Traction','Customers.xlsx','Sheet',5664,2),
